<template>
  ...
  <SimpleContainerBlockRenderer v-else-if="block.type === 'simple-container-block'" :block="block" :layout-mode="layoutMode" />
  <FlowContainerBlockRenderer v-else-if="block.type === 'flow-container-block'" :block="block" :layout-mode="layoutMode" />
</template>
...
type NativeRenderBlock = Exclude<RenderReadyCardBlock, { type: 'custom-block' }>

withDefaults(defineProps<{
  block: NativeRenderBlock
