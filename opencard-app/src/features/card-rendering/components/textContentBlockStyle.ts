...
import { resolveProjectFontExpression, type ProjectFontResolutionContext } from '../../workspace/model/projectFonts'
...
export function getTextContentBlockStyle(
  ...
  style += `; font-family: ${resolveProjectFontExpression(block.fontFamily, fontContext).cssFontFamily}`
