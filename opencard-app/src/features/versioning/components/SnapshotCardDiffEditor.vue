  ...
  <section class="snapshot-card-diff-editor" :class="`is-layout-${comparisonLayout}`">
    ...
    >
      ...
      <CardDesignEditor
        ...
        :comparison-added-block-ids="comparisonChanges?.addedBlockIds ? [...comparisonChanges.addedBlockIds] : undefined"
        :comparison-removed-block-ids="comparisonChanges?.removedBlockIds ? [...comparisonChanges.removedBlockIds] : undefined"
        :comparison-changed-instance-ids="comparisonChanges?.instanceIds ? [...comparisonChanges.instanceIds] : undefined"
        :comparison-added-instance-ids="comparisonChanges?.addedInstanceIds ? [...comparisonChanges.addedInstanceIds] : undefined"
        :comparison-removed-instance-ids="comparisonChanges?.removedInstanceIds ? [...comparisonChanges.removedInstanceIds] : undefined"
