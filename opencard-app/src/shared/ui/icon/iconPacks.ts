...
export const iconGlyphs = {
  ...
  'tool.clip-off': glyph(mdiPaperCutVertical),
  'tool.clip-on': glyph(mdiPaperCutVertical),
  ...
  'layout.inset': glyph(mdiArrowCollapseAll),
  'layout.outset': glyph(mdiArrowExpandAll),
