...
export const OC_SHARED_THEME_TOKENS = {
  ...
  '--oc-page-editor-indent': '12px',
  '--oc-page-editor-column-gap': '16px',
  '--oc-page-editor-row-min-height': '54px',
  '--oc-page-editor-title-min-width': '180px',
  '--oc-page-editor-content-min-width': '220px',
  '--oc-page-editor-value-width': '48px',
  '--oc-size-sm': '22px',
  '--oc-size-md': '28px',
  '--oc-size-lg': '36px',
  ...
  '--oc-shell-sidebar-collapse-threshold': '168px',
  ...
  '--oc-welcome-cover-wall-perspective': '900px',
  '--oc-welcome-cover-wall-rotate-x': '6deg',
  '--oc-welcome-cover-wall-rotate-y': '-9deg',
  '--oc-welcome-cover-wall-scale': '1.2',
  '--oc-welcome-cover-wall-blur': '9px',
  '--oc-welcome-cover-wall-opacity': '0.5',
  '--oc-welcome-hero-text-shadow': '0 1px 3px color-mix(in srgb, var(--oc-bg-base) 82%, transparent)',
  '--oc-welcome-background-mask': 'radial-gradient(ellipse at center, #000 0%, #000 52%, transparent 100%)',
  '--oc-welcome-cover-tile-emphasis-opacity': '0.92',
  '--oc-welcome-cover-tile-emphasis-scale': '1.18',
  '--oc-welcome-cover-wall-duration': '240s',
  ...
  '--oc-custom-block-preview-properties-width': '320px',
  ...
  '--oc-dialog-height-workspace': '720px',
...
const darkTheme: OcThemeTokens = {
  ...
  '--oc-fg-accent': '#b8b0ff',
  '--oc-fg-success': '#3fb950',
  '--oc-fg-warning': '#d29922',
  '--oc-fg-danger': '#f85149',
...
const lightTheme: OcThemeTokens = {
  ...
  '--oc-fg-accent': '#5a4fd6',
  '--oc-fg-success': '#1f9d68',
  '--oc-fg-warning': '#b77e18',
  '--oc-fg-danger': '#cf4444',
  ...
  '--oc-icon-file-opencard': 'oklch(74% 0.125 65)',
  '--oc-icon-file-json': 'oklch(76% 0.11 85)',
  '--oc-icon-file-markdown': 'oklch(70% 0.028 265)',
  '--oc-icon-file-typescript': 'oklch(67% 0.165 260)',
  '--oc-icon-file-javascript': 'oklch(77% 0.12 100)',
  '--oc-icon-file-vue': 'oklch(70% 0.11 158)',
  '--oc-icon-file-html': 'oklch(70% 0.155 34)',
  '--oc-icon-file-css': 'oklch(68% 0.13 250)',
  ...
  '--oc-icon-block-image': 'oklch(71% 0.2 320)',
  '--oc-icon-block-qrcode': 'oklch(71% 0.088 200)',
  '--oc-icon-block-shape': 'oklch(73% 0.1 75)',
  '--oc-icon-block-simple-container': 'oklch(69% 0.14 145)',
  '--oc-icon-block-flow-container': 'oklch(72% 0.155 38)',
